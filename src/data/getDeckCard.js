...
function addCard({ name, cmc, arena_id, card_faces, image_uris, set, collector_number, type_line, legalities, color_identity, rarity, oracle_text }, matches) {
    ...
    // Add card to matches
    matches.push({ name, cmc, arenaId: arena_id, set, imgs, collector_number, type_line, legalities, color_identity, rarity, oracle_text });
